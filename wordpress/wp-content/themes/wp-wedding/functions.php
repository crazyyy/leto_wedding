...
acf_update_setting('google_api_key', 'AIzaSyDacqLU9_YxrrJP2PTOWLhqo4ti2tYqiR8');
}
add_action('acf/init', 'my_acf_init');

function my_acf_google_map_api( $api ){
  $api['key'] = 'AIzaSyDacqLU9_YxrrJP2PTOWLhqo4ti2tYqiR8';
  return $api;
}
...
function wpeHeadNav() {
  ...
  array(
    ...
    'link_before'     => '',
    'link_after'      => '',
    'items_wrap'      => '<ul class="headnav col-md-12">%3$s</ul>',
    'depth'           => 0,
    'walker'          => ''
    )
  );
